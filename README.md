...
**You probably want [helmfile2compose](https://github.com/dekubeio/helmfile2compose)** — the full distribution with 9 bundled extensions (the Eight Monks + emptydir). This repo is for custom distributions and extension development.
...
| Repo | Description |
|------|-------------|
| [helmfile2compose](https://github.com/dekubeio/helmfile2compose) | Full distribution (core + 9 bundled extensions) |
